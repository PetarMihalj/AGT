...
\item Code generation - inference of the \texttt{main} function type and LLVM-IR generation
\end{enumerate}
...
\begin{itemize}
    ...
    the context of a type. For example, \texttt{arg!} applied to type \texttt{@i8},
...
Another example of contextual nature of syntactic elements is the \texttt{let <x> = <y>;} statement.
...
If the analyzer is currently in type context, \texttt{i8+a} gets substituted with
...
This section of the thesis will introduce the reader to AGT by presenting, explaining and discussing
example programs.
...
For first, a common problem with multiple source files in other languages is multiple inclusion
...
of desirable properties, and combine them to produce a usable programming language.
...
The type system and inference process, with this flavour, are a novel concept which 
...
We have provided many examples of AGT use, ranging from simple syntactic guides,
